...
public class OneCafeActivity extends ActionBarActivity implements ActionBar.TabListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_one_caffe);
        ...
        for (int i = 0; i < mSectionsPagerAdapter.getCount(); i++) {
            ...
            titleTV.setTypeface(Util.FONT_HEADINGS);
            titleTV.setTextSize(17);
            actionBar.addTab(
                    actionBar.newTab()
                            .setCustomView(titleTV)
                            .setTabListener(this)
            );
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.one_caffe, menu);
        return true;
    }
...
public class SectionsPagerAdapter extends FragmentPagerAdapter {
    ...
    public CharSequence getPageTitle(int position) {
        ...
        switch (position) {
            case 0:
                return "Podaci o kaficu";
            case 1:
                return "Lokacija kafica";
        }
        return null;
    }
}
